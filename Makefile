...
CPPFLAGS += -I$(GOOGLEAPIS_GENS_PATH) \
            -I$(GRPC_SRC_PATH) \
            -I/media/pi/4dbf987b-6d76-40bf-b87a-7e2f0abe2d0f/json_cpp/json/single_include \
            -I./src/
...
LDFLAGS += $(GRPC_GRPCPP_LDLAGS) \
           ...
           -lprotobuf -lpthread -ldl -ljson-c
else
LDFLAGS += $(GRPC_GRPCPP_LDLAGS) \
           -lgrpc_cronet -Wl,--no-as-needed -lgrpc++_reflection \
           -Wl,--as-needed -lprotobuf -lpthread -ldl -ljson-c
endif
...
GOOGLE_ASSISTANT_VOICE_CMD_SRCS = ./src/gas_voice_cmd.cc
...
ASSISTANT_O       = $(CORE_SRCS:.cc=.o) \
                    ...
                    $(GOOGLE_ASSISTANT_VOICE_CMD_SRCS:.cc=.o) \
